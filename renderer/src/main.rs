...
fn main() {
    ...
    for i in 0..model.face_count() {
        ...
        for j in 0..3 {
            ...
            // Very round-about way of scaling the x,y values to fit my width x height.
            let x0 = (v0.x + 1.0) * (width - 1) as f64/2.0 + 1.0;
            let y0 = (v0.y + 1.0) * (height -1) as f64/2.0 + 1.0;
            let x1 = (v1.x + 1.0) * (width - 1) as f64/2.0 + 1.0;
            let y1 = (v1.y + 1.0) * (height -1) as f64/2.0 + 1.0;
